          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="project-header">
                <span className="project-emoji">{projectEmojis[project.title] || projectEmojis['default']}</span>
                <h2 className="project-title">{project.title}</h2>
                <svg className="project-github-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
